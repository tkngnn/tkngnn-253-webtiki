var container = {
    ...
    login: function () {
        ...
        showLogin = document.querySelector('.register__header');
    ...
    bannerSlider1: function () {
        var bannerSize = document.querySelector('.trademark-slider-app-1').clientWidth;

        var banner = document.querySelector('.trademark-slider-full-1');

        var bannerPrev = document.querySelector('.banner-prev-1');

        var bannerNext = document.querySelector('.banner-next-1');
    ...
    bannerSlider3: function () {
        var bannerSize = document.querySelector('.trademark-slider-app-3').clientWidth;

        var banner = document.querySelector('.trademark-slider-full-3');

        var bannerPrev = document.querySelector('.banner-prev-3');

        var bannerNext = document.querySelector('.banner-next-3');
    ...
    bannerSlider2: function () {
        var bannerSize = document.querySelector('.trademark-slider-app-2').clientWidth;

        var banner = document.querySelector('.trademark-slider-full-2');

        var bannerPrev = document.querySelector('.banner-prev-2');

        var bannerNext = document.querySelector('.banner-next-2');

        var bannerFull = bannerSize * 3;
